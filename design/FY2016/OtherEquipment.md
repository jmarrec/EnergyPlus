...
We have not had any emails or conference calls, but there was a lot of discussion on the [GitHub issue](https://github.com/NatLabRockies/EnergyPlus/issues/5656). Several options were proposed. Including:
...
4. Equipment that replaces all interior/exterior, gas/electric/other. From [below](https://github.com/NatLabRockies/EnergyPlus/issues/5656#issuecomment-220482638)
5. Create a `FuelEquipment` to replace `GasEquipment`. From [below](https://github.com/NatLabRockies/EnergyPlus/issues/5656#issuecomment-219066932)
6. Add "Fuel Type" field to `OtherEquipment`. From [below](https://github.com/NatLabRockies/EnergyPlus/issues/5656#issuecomment-221892458)
