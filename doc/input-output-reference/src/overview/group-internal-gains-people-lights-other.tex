...
Internal gains (Space Loads) object types are split into a paired \textbf{Instance} object and a \textbf{Definition} object.

\begin{itemize}
\tightlist
\item \hyperref[people]{People} / \hyperref[peopledefinition]{People:Definition}
\item \hyperref[lights-000]{Lights} / \hyperref[lightsdefinition]{Lights:Definition}
\item \hyperref[electricequipment]{ElectricEquipment} / \hyperref[electricequipmentdefinition]{ElectricEquipment:Definition}
\item \hyperref[gasequipment]{GasEquipment} / \hyperref[gasequipmentdefinition]{GasEquipment:Definition}
\item \hyperref[hotwaterequipment]{HotWaterEquipment} / \hyperref[hotwaterequipmentdefinition]{HotWaterEquipment:Definition}
\item \hyperref[steamequipment]{SteamEquipment} / \hyperref[steamequipmentdefinition]{SteamEquipment:Definition}
\item \hyperref[otherequipment]{OtherEquipment} / \hyperref[otherequipmentdefinition]{OtherEquipment:Definition}
\item \hyperref[electricequipmentiteaircooled]{ElectricEquipment:ITE:AirCooled} / \hyperref[electricequipmentiteaircooleddefinition]{ElectricEquipment:ITE:AirCooled:Definition}
\end{itemize}
...
This object defines the occupancy calculation method, heat gain fractions, CO\(_{2}\) generation rate, and thermal comfort model types shared by one or more \hyperref[people]{People} instances.

\subsubsection{Inputs}\label{inputs-peopledefinition}

\paragraph{Field: Name}\label{field-name-peopledefinition}

The name of the People:Definition object. This name is referenced by the \textit{People Definition Name} field of \hyperref[people]{People} instances.
...
This object defines the design-level calculation method and heat gain fractions shared by one or more \hyperref[lights-000]{Lights} instances.

\subsubsection{Inputs}\label{inputs-2-lightsdefinition}

\paragraph{Field: Name}\label{field-name-lightsdefinition}

The name of the Lights:Definition object. This name is referenced by the \textit{Lights Definition Name} field of \hyperref[lights-000]{Lights} instances.
...
This object defines the design-level calculation method and heat gain fractions shared by one or more \hyperref[electricequipment]{ElectricEquipment} instances.
...
The name of the ElectricEquipment:Definition object. This name is referenced by the \textit{Electric Equipment Definition Name} field of \hyperref[electricequipment]{ElectricEquipment} instances.
...
This object defines the design-level calculation method, heat gain fractions, and CO\(_{2}\) generation rate shared by one or more \hyperref[gasequipment]{GasEquipment} instances.

\subsubsection{Inputs}\label{inputs-4-gasequipmentdefinition}

\paragraph{Field: Name}\label{field-name-gasequipmentdefinition}

The name of the GasEquipment:Definition object. This name is referenced by the \textit{Gas Equipment Definition Name} field of \hyperref[gasequipment]{GasEquipment} instances.
...
This object defines the design-level calculation method and heat gain fractions shared by one or more \hyperref[hotwaterequipment]{HotWaterEquipment} instances.
...
The name of the HotWaterEquipment:Definition object. This name is referenced by the \textit{Hot Water Equipment Definition Name} field of \hyperref[hotwaterequipment]{HotWaterEquipment} instances.
...
This object defines the design-level calculation method and heat gain fractions shared by one or more \hyperref[steamequipment]{SteamEquipment} instances.
...
The name of the SteamEquipment:Definition object. This name is referenced by the \textit{Steam Equipment Definition Name} field of \hyperref[steamequipment]{SteamEquipment} instances.
...
This object defines the design-level calculation method, heat gain fractions, and CO\(_{2}\) generation rate shared by one or more \hyperref[otherequipment]{OtherEquipment} instances.
...
The name of the OtherEquipment:Definition object. This name is referenced by the \textit{Other Equipment Definition Name} field of \hyperref[otherequipment]{OtherEquipment} instances.
...
This field is multiplied by the Watts per Unit (from the definition) to determine the design electrical power input to this ITE object. This field is used when the Design Power Input Calculation Method is ``Watts/Unit''. The default is 1.
...
This object defines the performance characteristics shared by one or more \hyperref[electricequipmentiteaircooled]{ElectricEquipment:ITE:AirCooled} instances.
...
The name of the ElectricEquipment:ITE:AirCooled:Definition object. This name is referenced by the \textit{ElectricEquipment ITE AirCooled Definition Name} field of \hyperref[electricequipmentiteaircooled]{ElectricEquipment:ITE:AirCooled} instances.
...
\tightlist
\item
  \textbf{Watts/Unit} -- With this choice, the design power input will be the product of Watts per Unit and Number of Units (from the instance). This is the default.
\item
  \textbf{Watts/Area} -- With this choice, the design power input will be a factor per floor area of the zone. (The Watts per Floor Area field should be filled.)
\end{itemize}

\paragraph{Field: Watts per Unit}\label{field-watts-per-unit}

This field (in Watts) is the design electrical power input to the ITE per unit when fully loaded and the entering air temperature is at the specified design value. Used when the Design Power Input Calculation Method is ``Watts/Unit''.
