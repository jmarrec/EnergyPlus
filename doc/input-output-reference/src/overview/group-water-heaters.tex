...
The name of a material defined in the \emph{Material} object that has phase‐change properties (\lstinline!hasPCM = Yes!).  This material provides the melting/freezing temperature and latent heat used in the simulation.
...
\item
  Thermal Energy Storage Latent Heat Capacity~~~~~~~~~~~~ !- HVAC Sum [J]
\item
...
\paragraph{Thermal Energy Storage Latent Heat Capacity [J]}\label{pcmstorage-latent-heat-capacity}

The total latent heat capacity of the PCM tank.
