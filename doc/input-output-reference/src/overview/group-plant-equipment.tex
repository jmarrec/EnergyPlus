...
\begin{itemize}
    ...
    \item
    HVAC,Average,Boiler Coefficient of Performance {[}W/W{]}
\end{itemize}
...
\paragraph{Boiler Coefficient of Performance {[]}}\label{boiler-coefficient-of-performance}

This output is the coefficient of performance for the boiler during heating operation. It is calculated by dividing the boiler heating rate by the sum of the boiler electricity rate, boiler ancillary electricity rate and the boiler ancillary fuel (fuel type dependent) rate.
...
\begin{itemize}
    ...
    \item
    HVAC,Average,Boiler Steam Coefficient of Performance {[}W/W{]}
    \item
    Zone,Meter,Boilers:EnergyTransfer {[}J{]}
    \item
...
\paragraph{Boiler Steam Coefficient of Performance {[]}}\label{boile-steamr-coefficient-of-performance}

This output is the coefficient of performance for the steam boiler during heating operation. It is calculated by dividing the boiler heating rate by the boiler fuel rate.
...
\item Heat Pump Fractional Defrost Time {[}W{]}
