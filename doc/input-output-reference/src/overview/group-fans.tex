...
\hyperref[fansystemmodel]{Fan:SystemModel} fans have replaced \hyperref[fanperformancenightventilation]{FanPerformance:NightVentilation} (i.e., specifies the same night ventilation performance parameters).
...
This is the name of a fan defined elsewhere in the input file. The night vent performance parameters will be applied to the named fan when a system manager (such as \emph{\hyperref[availabilitymanagernightventilation]{AvailabilityManager:NightVentilation}}) has set the air system flow rate.
