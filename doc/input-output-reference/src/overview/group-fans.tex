...
FIXME This output contains

\paragraph{Fan Runtime Fraction Speed {[]}}\label{fan-runtime-fraction-fansysmodel}

FIXME This output contains the fraction of time operated for the single-speed fan for the timestep being reported.

\paragraph{Fan Runtime Fraction Speed <\#> {[]}}\label{fan-runtime-fraction-fansysmodel}

FIXME This output contains the fraction of time operated for the fan speed for the timestep being reported.
...
This output field contains the average air mass flow rate in kg/s for the time interval being reported.

\paragraph{Fan Heat Gain to Air {[}W{]}}\label{fan-heat-gain-to-air-w}

FIXME This output field contains
