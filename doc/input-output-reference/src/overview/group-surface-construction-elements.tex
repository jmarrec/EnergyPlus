...
\paragraph{Field: Thermal Absorptance Outside Face}\label{field-thermal-absorptance-outside-face}
...
\paragraph{Field: Solar Absorptance Outside Face}\label{field-solar-absorptance-outside-face}
...
\paragraph{Field: Visible Absorptance Outside Face}\label{field-visible-absorptance-outside-face}
...
\paragraph{Field: Thermal Absorptance Outside Face}\label{field-thermal-absorptance-outside-face-1}
...
\paragraph{Field: Solar Absorptance Outside Face}\label{field-solar-absorptance-outside-face-1}

The solar absorptance field in the Material input syntax represents the fraction of incident~ solar radiation that is absorbed by the material. This particular field is for the exterior side or outside face. Solar radiation (0.3 to 2.537 $\mu{}m$) includes the visible spectrum as well as infrared and ultraviolet wavelengths. This parameter is used when calculating the amount of incident solar radiation absorbed by various surfaces and affects the surface heat balances. If solar reflectance (or reflectivity) data is available, then absorptance is equal to 1.0 minus reflectance (for opaque materials). Values for this field must be between 0.0 and 1.0. The default value for this field is 0.7.

\paragraph{Field: Visible Absorptance Outside Face}\label{field-visible-absorptance-outside-face-1}
...
\paragraph{Field: Control Signal Outside Face}\label{field-control-signal-outside-face}
...
\paragraph{Field: Thermal Absorptance Function Name Outside Face}\label{field-thermal-absorptance-function-name-outside-face}
...
\paragraph{Field: Thermal Absorptance Schedule Name Outside Face}\label{field-thermal-absorptance-schedule-name-outside-face}
...
\paragraph{Field: Solar Absorptance Function Name Outside Face}\label{field-solar-absorptance-function-name-outside-face}
...
\paragraph{Field: Solar Absorptance Schedule Name Outside Face}\label{field-solar-absorptance-schedule-name-outside-face}
