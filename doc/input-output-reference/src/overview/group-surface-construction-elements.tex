...
\paragraph{Field: Visible Absorptance Outside Face}\label{field-visible-absorptance}
...
Material,
  ...
  0.9000000,                  !- Thermal Absorptance Outside Face
  0.9300000,                  !- Solar Absorptance Outside Face
  0.9300000;                  !- Visible Absorptance Outside Face
\end{lstlisting}
...
Material,
  ...
  0.9000000,                   !- Thermal Absorptance Outside Face
  0.7000000,                   !- Solar Absorptance Outside Face
  0.7000000,                   !- Visible Absorptance Outside Face
...
Material:NoMass,
  ...
  0.9000000,     !- Thermal Absorptance Outside Face
  0.7500000,     !- Solar Absorptance Outside Face
  0.7500000;     !- Visible Absorptance Outside Face
\end{lstlisting}
...
TThe name of a Schedule object that overwrites the material solar absorptance at the outside face or exterior side. If neither this field or the previous field are defined, then the solar absorptance is assumed to be constant.
...
TThe name of a Schedule object that overwrites the material solar absorptance at the inside face or interior side. If neither this field or the previous field are defined, then the solar absorptance is assumed to be constant.
