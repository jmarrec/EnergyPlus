...
\begin{equation}
{\mathrm{NU2}} = 0.242{\left( {{\raise0.7ex\hbox{{{\mathrm{Ra}}}} \!\mathord{\left/ {\vphantom {{{\mathrm{Ra}}} {\mathrm{A}}}}\right.}\!\lower0.7ex\hbox{{\mathrm{A}}}}} \right)^{0.272}}
\end{equation}
...
\begin{equation}
{h_{net}} = {\mathrm{k}}\left( {{\raise0.7ex\hbox{{{\mathrm{NU}}}} \!\mathord{\left/ {\vphantom {{{\mathrm{NU}}} {\mathrm{L}}}}\right.}\!\lower0.7ex\hbox{{\mathrm{L}}}}} \right)
\end{equation}
