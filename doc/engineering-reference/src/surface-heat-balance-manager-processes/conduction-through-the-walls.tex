...
\begin{equation}
\frac{{d\left[ {\mathbf{x}} \right]}}{{dt}} = \left[ {\mathbf{A}} \right]\left[ {\mathbf{x}} \right] + \left[ {\mathbf{B}} \right]\left[ {\mathbf{u}} \right]
\end{equation}

\begin{equation}
\left[ {\mathbf{y}} \right] = \left[ {\mathbf{C}} \right]\left[ {\mathbf{x}} \right] + \left[ {\mathbf{D}} \right]\left[ {\mathbf{u}} \right]
\end{equation}
...
\begin{equation}
\frac{d\left[\begin{array}{c}T_1 \\ \vdots \\ T_n\end{array}\right]}{dt} = \left[\mathbf{A}\right]\left[\begin{array}{c}T_1 \\ \vdots \\ T_n\end{array}\right]+\left[\mathbf{B}\right]\left[\begin{array}{c}T_i \\ T_o\end{array}\right]
\end{equation}

\begin{equation}
\left[\begin{array}{c}{q''}_i \\ {q''}_o\end{array}\right] = \left[\mathbf{C}\right]\left[\begin{array}{c}T_1 \\ \vdots \\ T_n\end{array}\right]+\left[\mathbf{D}\right]\left[\begin{array}{c}T_i \\ T_o\end{array}\right]
\end{equation}
