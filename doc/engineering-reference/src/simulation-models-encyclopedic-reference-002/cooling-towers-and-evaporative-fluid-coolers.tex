...
where \({T_{{\mathrm{setpoint}}}}\) is the outlet water setpoint temperature (\(^{\circ}\)C).
...
\begin{equation}
{T_{water,outlet}} = {T_{{\mathrm{setpoint}}}} = {T_{wb,air}} + {T_{approach}}
\end{equation}
...
\begin{equation}
  P_{fan} = \left( {{P_{fan,design}}} \right)\left( {FanPLR} \right){\left( {F{R_{air}}} \right)^{\mathrm{3}}}
\end{equation}
...
\({P_{{\mathrm{heater,basin}}}}\) is the tower basin heater electric power (W)

\({E_{{\mathrm{heater,basin}}}}\) is the tower basin heater electric consumption (J)
...
\begin{equation}
{\dot Q_{water}} = {\dot m_{_{water}}}{C_p}\left( {{T_{{\mathrm{water,inlet}}}} - {T_{{\mathrm{water,outlet}}}}} \right)
\end{equation}
...
\begin{equation}
{T_{sat\,air,outlet}} = PsyTsatFnHPb\left( {{h_{sat\,air,outlet}},{\mathrm{OutBaroPress}}} \right)
\end{equation}
...
\({\mathrm{OutBaroPress}}\) is the outdoor barometric pressure (Pa)
