...
\begin{equation}
  {I_{tot}}({i_L}) = \sum\limits_{\genfrac{}{}{0pt}{2}{\mathrm{windows}}{\mathrm{in~zone}}} {{I_{win}}({i_s},{i_L})}
\end{equation}
...
\begin{equation}
  {B_{tot}}({i_L}) = \sum\limits_{\genfrac{}{}{0pt}{2}{\mathrm{windows}}{\mathrm{in~zone}}} {{B_{win}}({i_s},{i_L})}
\end{equation}
...
\begin{equation}
  {G_I}({i_L}) = 10{\log_{10}}\sum\limits_{\genfrac{}{}{0pt}{2}{\mathrm{windows}}{\mathrm{in~zone}}} {\frac{{{S_{win}}{{({i_L},{i_S})}^{1.6}}\Omega {{({i_L})}^{0.8}}}}{{B({i_L}) + 0.07\omega {{({i_L})}^{0.5}}{S_{win}}({i_L},{i_S})}}}
\end{equation}
