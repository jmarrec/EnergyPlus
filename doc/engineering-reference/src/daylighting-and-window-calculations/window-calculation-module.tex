...
\begin{equation}
\int\limits_\Omega  {\delta ({{\mathbf{p}}^{{\mathrm{(2)}}}},{{\mathbf{p}}^{{\mathrm{(1)}}}})d{\Omega ^{{\mathrm{(1)}}}}}  = \left\{ {\begin{array}{*{20}{c}}1&{{{\mathbf{p}}^{{\mathrm{(2)}}}} \in \Omega }\\0&{{{\mathbf{p}}^{{\mathrm{(2)}}}} \notin \Omega }\end{array}} \right.
...
\begin{equation}
\int\limits_A {\delta ({{\mathbf{x}}^{{\mathrm{(2)}}}},{{\mathbf{x}}^{{\mathrm{(1)}}}})d{A^{{\mathrm{(1)}}}}}  = \left\{ {\begin{array}{*{20}{c}}1&{{{\mathbf{x}}^{{\mathrm{(2)}}}} \in A}\\0&{{{\mathbf{x}}^{{\mathrm{(2)}}}} \notin A}\end{array}} \right.
\end{equation}
...
\begin{equation}
\begin{array}{*{20}{c}}{{\mathbf{\Lambda }^{{\mathrm{(s)}}}} = \left( {{\Lambda ^{{\mathrm{(s)}}}}_{ij}} \right)}&{{\mathrm{where}}}&{\Lambda_{ij}^{{\mathrm{(s)}}} = \left( {{{\mathbf{p}}_j}\cdot {{\mathbf{n}}^{{\mathrm{(s)}}}}} \right)\Delta {\Omega_j}{\delta_{ij}}}\end{array}
...
\begin{equation}
\begin{array}{*{20}{c}}{{S^{{\mathrm{(T)}}}}_j = \sum\limits_i {{T_{ji}}} \sum\limits_k {{\Lambda_{ik}}} {S_k}}&{{\mathrm{where}}}&{{T_{ji}} = {\mathcal{T}} ({{\mathbf{p}}_j}^{{\mathrm{(T)}}},{{\mathbf{p}}_i}^{{\mathrm{(I)}}})}\end{array}
\end{equation}
