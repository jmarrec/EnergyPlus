...
\begin{equation}
S({{\bf{p}}^{{\mathrm{(T)}}}}) = {\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})dE({{\bf{p}}^{{\mathrm{(I)}}}})
...
\begin{equation}
S({{\bf{p}}^{{\mathrm{(T)}}}}) = \int {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})\frac{{dE({{\bf{p}}^{{\mathrm{(I)}}}})}}{{d\Omega }}d\Omega }
...
\begin{equation}
S({{\bf{p}}^{{\mathrm{(R)}}}}) = \int {{\mathop{\rm \mathcal{R}}\nolimits} ({{\bf{p}}^{{\mathrm{(R)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})\frac{{dE({{\bf{p}}^{{\mathrm{(I)}}}})}}{{d\Omega }}d\Omega }
...
\begin{equation}
dE({{\bf{p}}^{{\mathrm{(I)}}}})dA = {S^{{\mathrm{(I)}}}}({{\bf{p}}^{{\mathrm{(I)}}}})\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}dA
...
\begin{equation}
S({{\bf{p}}^{{\mathrm{(T)}}}}) = \int\limits_{{\Omega ^{{\mathrm{(I)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}}){S^{{\mathrm{(I)}}}}({{\bf{p}}^{{\mathrm{(I)}}}})\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}}
...
\begin{equation}
{E^{{\mathrm{(2)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})d{A^{{\mathrm{(2)}}}} = {S^{{\mathrm{(T)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})\left( { - {{\bf{p}}^{{\mathrm{(T)}}}}\cdot {{\bf{n}}^{{\mathrm{(2)}}}}} \right)d{\Omega ^{{\mathrm{(I,2)}}}}d{A^{{\mathrm{(2)}}}}
...
\begin{equation}
{W^{(1 \to 2)}} = \left( {{S^{{\mathrm{(1)}}}}({{{\bf{\hat r}}}^{{\mathrm{(1)}}}}) - {S^{{\mathrm{(2)}}}}({{{\bf{\hat r}}}^{{\mathrm{(2)}}}})} \right)\frac{{\left( {d{{\bf{A}}^{{\mathrm{(1)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(1)}}}}} \right)\left( {d{{\bf{A}}^{{\mathrm{(2)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(2)}}}}} \right)}}{{{r^2}}}
\end{equation}

where \({S^{{\mathrm{(1)}}}}({{\bf{\hat r}}^{{\mathrm{(1)}}}})\) ~is the radiance leaving surface element 1 in the direction of surface element 2, and vice-versa for \({S^{{\mathrm{(2)}}}}({{\bf{\hat r}}^{{\mathrm{(2)}}}})\) .~ In this case, the latter is zero and the former is the quantity called \emph{S}\(^{(T)}\)(\textbf{\emph{p}}\(^{(T)}\)) above.~ Given Equation~\ref{eq:dOmegaI2Equation}, we can recognize the quantity multiplying the radiance as the solid angle \emph{d}\(\Omega\)\(^{(I,2)}\) times the projected area of surface element 2 perpendicular to \textbf{\emph{r}}.~ But the expression is symmetrical in the two surface elements, so we could also express it as:

\begin{equation}
{W^{(1 \to 2)}} = {S^{{\mathrm{(T)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})\left( {d{{\bf{A}}^{{\mathrm{(1)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(1)}}}}} \right)d{\Omega ^{{\mathrm{(T)}}}}
\end{equation}

where

\begin{equation}
d{\Omega ^{{\mathrm{(T)}}}} = \frac{{\left( {d{{\bf{A}}^{{\mathrm{(2)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(2)}}}}} \right)}}{{{r^2}}}
\end{equation}
...
\begin{equation}
{E^{{\mathrm{(2)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})d{A^{{\mathrm{(2)}}}} = {S^{{\mathrm{(T)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})\left( {{{\bf{n}}^{{\mathrm{(1)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(1)}}}}} \right)d{\Omega ^{{\mathrm{(T)}}}}d{A^{{\mathrm{(1)}}}}
\label{eq:E2pTdA2Equation}
\end{equation}

and since, as can readily be seen from Figure~\ref{fig:radiation-exchange-between-two-surface}, \(\left( {d{{\bf{A}}^{{\mathrm{(1)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(1)}}}}} \right) = \left( {d{{\bf{A}}^{{\mathrm{(2)}}}} \cdot {{{\bf{\hat r}}}^{{\mathrm{(2)}}}}} \right)\) , this becomes:

\begin{equation}
{E^{{\mathrm{(2)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = {S^{{\mathrm{(T)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})\left( { - {{\bf{p}}^{{\mathrm{(T)}}}} \cdot {{\bf{n}}^{{\mathrm{(2)}}}}} \right)d{\Omega ^{{\mathrm{(T)}}}}
\end{equation}
...
\begin{equation}
{E^{{\mathrm{(2)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = \int\limits_{{\Omega ^{{\mathrm{(I)}}}}} {{\mathop{\rm T}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})E({{\bf{p}}^{{\mathrm{(I)}}}})d{\Omega ^{{\mathrm{(I)}}}}} \left( { - {{\bf{p}}^{{\mathrm{(T)}}}} \cdot {{\bf{n}}^{{\mathrm{(2)}}}}} \right)d{\Omega ^{{\mathrm{(T)}}}}
\end{equation}
...
\begin{equation}
{E^{(2)}}({{\bf{p}}^{{\mathrm{(2)}}}}) = \int {\mathcal{L}({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{p}}^{{\mathrm{(2)}}}};{{\bf{x}}^{{\mathrm{(1)}}}},{{\bf{p}}^{{\mathrm{(1)}}}}){S^{{\mathrm{(1)}}}}({{\bf{p}}^{{\mathrm{(1)}}}})} d{\Omega ^{{\mathrm{(1)}}}}
...
\begin{equation}
\mathcal{L}({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{p}}^{{\mathrm{(2)}}}};{{\bf{x}}^{{\mathrm{(1)}}}},{{\bf{p}}^{{\mathrm{(1)}}}}) = \left( { - {{\bf{p}}^{{\mathrm{(2)}}}}\cdot {{\bf{n}}^{{\mathrm{(2)}}}}} \right)d{\Omega ^{{\mathrm{(2)}}}}\delta ({{\bf{p}}^{{\mathrm{(2)}}}},{{\bf{p}}^{{\mathrm{(1)}}}})\delta ({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{x}}^{{\mathrm{(1)}}}} + {\bf{r}})
...
\begin{equation}
\int {\delta ({{\bf{p}}^{{\mathrm{(2)}}}},{{\bf{p}}^{{\mathrm{(1)}}}})} f({{\bf{p}}^{{\mathrm{(1)}}}})d{\Omega ^{{\mathrm{(1)}}}} = f({{\bf{p}}^{{\mathrm{(2)}}}})
\label{eq:deltap2p1fp1dOmega1Equation}
\end{equation}

\begin{equation}
\int\limits_\Omega  {\delta ({{\bf{p}}^{{\mathrm{(2)}}}},{{\bf{p}}^{{\mathrm{(1)}}}})d{\Omega ^{{\mathrm{(1)}}}}}  = \left\{ {\begin{array}{*{20}{c}}1&{{{\bf{p}}^{{\mathrm{(2)}}}} \in \Omega }\\0&{{{\bf{p}}^{{\mathrm{(2)}}}} \notin \Omega }\end{array}} \right.
\label{eq:deltap2p1dOmega1Integral}
\end{equation}

\begin{equation}
\int {\delta ({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{x}}^{{\mathrm{(1)}}}})} f({{\bf{x}}^{{\mathrm{(1)}}}})d{A^{{\mathrm{(1)}}}} = f({{\bf{x}}^{{\mathrm{(2)}}}})
\end{equation}

\begin{equation}
\int\limits_A {\delta ({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{x}}^{{\mathrm{(1)}}}})d{A^{{\mathrm{(1)}}}}}  = \left\{ {\begin{array}{*{20}{c}}1&{{{\bf{x}}^{{\mathrm{(2)}}}} \in A}\\0&{{{\bf{x}}^{{\mathrm{(2)}}}} \notin A}\end{array}} \right.
\end{equation}
...
\begin{equation}
S({{\bf{p}}_j}^{{\mathrm{(T)}}}) = \sum\limits_i {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}_j}^{{\mathrm{(T)}}},{{\bf{p}}_i}^{{\mathrm{(I)}}}){S^{{\mathrm{(I)}}}}({{\bf{p}}_i}^{{\mathrm{(I)}}})\left( { - {{\bf{p}}_i}^{{\mathrm{(I)}}}\cdot {\bf{n}}} \right)\Delta {\Omega_i}^{{\mathrm{(I)}}}}
...
\begin{equation}
{E^{(2)}}({{\bf{p}}_j}^{{\mathrm{(2)}}}) = \sum\limits_i {\int\limits_{\Delta {\Omega_i}} {\mathcal{L}({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{p}}_j}^{{\mathrm{(2)}}};{{\bf{x}}^{{\mathrm{(1)}}}},{{\bf{p}}_i}^{{\mathrm{(1)}}}){S^{{\mathrm{(1)}}}}({{\bf{p}}_i}^{{\mathrm{(1)}}})d{\Omega ^{{\mathrm{(1)}}}}} }
\end{equation}
...
\begin{equation}
\int\limits_{\Delta {\Omega_i}} {\mathcal{L}({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{p}}_j}^{{\mathrm{(2)}}};{{\bf{x}}^{{\mathrm{(1)}}}},{{\bf{p}}_i}^{{\mathrm{(1)}}}){S^{{\mathrm{(1)}}}}({{\bf{p}}_i}^{{\mathrm{(1)}}})d{\Omega ^{{\mathrm{(1)}}}}}  = \lambda ( - {{\bf{p}}_j}^{{\mathrm{(2)}}}){\delta_{ij}} \cdot \delta ({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{x}}^{{\mathrm{(1)}}}} + {\bf{r}})
...
\begin{equation}
{\lambda ^{{\mathrm{(s)}}}}({{\bf{p}}_j}) = \left( {{{\bf{p}}_j}\cdot {{\bf{n}}^{{\mathrm{(s)}}}}} \right)\Delta {\Omega_j}
\label{eq:lambdaspjEquation}
\end{equation}

and the superscript (s) refers to the surface.

The LBNL method, which focuses on glazing systems consisting of plane-parallel layers, makes particular assumptions that allow one to ignore the spatial dependence of $\mathcal{L}$.~ Since the only effect of the function \(\delta ({{\bf{x}}^{{\mathrm{(2)}}}},{{\bf{x}}^{{\mathrm{(1)}}}} + {\bf{r}})\)~in Equation~\ref{eq:ScriptLEquation} is to require that if the expression is formally integrated over two separate surface areas, only the parts of the integration that satisfy the geometric constraints will contribute (in effect, the integration is over only one of the surfaces), we will drop the spatial dependence in the present discussion and replace it later when we consider the total energy transfer between different surfaces.
...
\begin{equation}
\begin{array}{*{20}{c}}{{\bf{\Lambda }^{{\mathrm{(s)}}}} = \left( {{\Lambda ^{{\mathrm{(s)}}}}_{ij}} \right)}&{{\mathrm{where}}}&{\Lambda_{ij}^{{\mathrm{(s)}}} = \left( {{{\bf{p}}_j}\cdot {{\bf{n}}^{{\mathrm{(s)}}}}} \right)\Delta {\Omega_j}{\delta_{ij}}}\end{array}
...
\begin{equation}
\begin{array}{*{20}{c}}{{S^{{\mathrm{(T)}}}}_j = \sum\limits_i {{T_{ji}}} \sum\limits_k {{\Lambda_{ik}}} {S_k}}&{{\mathrm{where}}}&{{T_{ji}} = {\mathcal{T}} ({{\bf{p}}_j}^{{\mathrm{(T)}}},{{\bf{p}}_i}^{{\mathrm{(I)}}})}\end{array}
\end{equation}
...
\begin{equation}
{R_{ij}} = {\mathcal{R}} ({{\bf{p}}^{{\mathrm{(R)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})
...
\begin{equation}
{{\bf{S}}^{{\mathrm{(T)}}}} = {\bf{T}} \cdot {{\bf{E}}^{{\mathrm{(I)}}}}
\end{equation}

\begin{equation}
{{\bf{S}}^{{\mathrm{(R)}}}} = {\bf{R}} \cdot {{\bf{E}}^{{\mathrm{(I)}}}}
\end{equation}

\begin{equation}
{{\bf{E}}^{{\mathrm{(I)}}}}{\bf{ = }}{\bf{\Lambda }^{{\mathrm{(I)}}}} \cdot {{\bf{S}}^{{\mathrm{(I)}}}}
\end{equation}

\begin{equation}
{{\bf{S}}^{{\mathrm{(T)}}}}{\bf{ = T}} \cdot {\bf{\Lambda }^{{\mathrm{(I)}}}} \cdot {{\bf{S}}^{{\mathrm{(I)}}}}
\end{equation}
...
EnergyPlus models the exterior radiance in two parts, a moving sun radiance \({S^{{\mathrm{(Sun)}}}}(t)\Delta {\Omega ^{{\mathrm{(Sun)}}}}\) ~and a constant-shape direction-dependent sky radiance \({S^{{\mathrm{(Sky)}}}}({\bf{p}},t)\) .~ The intensities of these vary with time.~ For the solar radiation there is a single sky radiance model.~ For daylight calculations the treatment is similar for exterior luminance, except that there are a number of user-selectable sky luminance models.~ Here we will discuss radiance; the treatment of luminance is analogous.
...
\begin{equation}
{S^{{\mathrm{(Sky)}}}}({\bf{p}},t) = {I^{{\mathrm{(Sky)}}}}(t)s({\bf{p}})
\end{equation}
...
\begin{equation}
{I^{{\mathrm{(G)}}}}(t) = {I^{{\mathrm{(Sky)}}}}(t)\left( {1 - \int\limits_{\Delta {\Omega ^{{\mathrm{(Sun)}}}}} {s({\bf{p}})d\Omega } } \right) + {I^{{\mathrm{(D)}}}}(t)\cos {\theta ^{{\mathrm{(Sun)}}}}(t)
\end{equation}
...
\begin{equation}
\begin{array}{c}S({{\bf{p}}^{{\mathrm{(T)}}}}) = {I^{({\bf{Sky}})}}(t)\int\limits_{{\Omega ^{{\mathrm{(Sky)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})s({{\bf{p}}^{{\mathrm{(I)}}}})\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}} \\ + \int\limits_{{\Omega ^{{\mathrm{(Gnd)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}}){S^{{\mathrm{(Gnd)}}}}({{\bf{p}}^{{\mathrm{(I)}}}},t)\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}} \\ + H\left( {\Delta {\Omega ^{{\mathrm{(Sun)}}}}(t) \not\subset {\Omega ^{{\mathrm{(Sf)}}}}} \right)\int\limits_{\Delta {\Omega ^{{\mathrm{(Sun)}}}}(t)} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}}){S^{{\mathrm{(Sun)}}}}({{\bf{p}}^{{\mathrm{(I)}}}},t)\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}} \\ + \int\limits_{{\Omega ^{{\mathrm{(Sf)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}}){S^{{\mathrm{(Refl)}}}}({{\bf{p}}^{{\mathrm{(I)}}}},t)\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}} \end{array}
\end{equation}
...
\begin{equation}
S({{\bf{p}}^{{\mathrm{(T)}}}}) = {S^{{\mathrm{(Sky)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) + {S^{{\mathrm{(Gnd)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) + {S^{{\mathrm{(Sun)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) + {S^{{\mathrm{(Sf)}}}}({{\bf{p}}^{{\mathrm{(T)}}}})
...
\begin{equation}
\begin{array}{c}{S^{{\mathrm{(Sun)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = H\left( {\Delta {\Omega ^{{\mathrm{(Sun)}}}}(t) \not\subset {\Omega ^{{\mathrm{(Sf)}}}}} \right)\\ \times \int\limits_{\Delta {\Omega ^{{\mathrm{(Sun)}}}}(t)} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})\left[ {{S^{{\mathrm{(Sun)}}}}({{\bf{p}}^{{\mathrm{(I)}}}},t) - {I^{({\bf{Sky}})}}(t)s({{\bf{p}}^{{\mathrm{(I)}}}})} \right]\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}} \end{array}
\label{eq:SSunpTEquation}
\end{equation}

\begin{equation}
{S^{{\mathrm{(Sky)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = {I^{({\bf{Sky}})}}(t)\int\limits_{{\Omega ^{{\mathrm{(Sky)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}})s({{\bf{p}}^{{\mathrm{(I)}}}})\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}}
...
\begin{equation}
{S^{{\mathrm{(Sun)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = {\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(Sun)}}}})\left[ {{I^{{\mathrm{(D)}}}} - {I^{{\mathrm{(Sky)}}}}s({{\bf{p}}^{{\mathrm{(Sun)}}}})\Delta {\Omega ^{{\mathrm{(Sun)}}}}} \right]\cos {\theta ^{{\mathrm{(Sun)}}}}H\left( {{{\bf{p}}^{{\mathrm{(Sun)}}}} \not\subset {\Omega ^{{\mathrm{(Sf)}}}}} \right)
\end{equation}
...
\begin{equation}
{S^{{\mathrm{(Sf, n)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = \int\limits_{{\Omega ^{{\mathrm{(Sf, n)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}}){S^{{\mathrm{(Refl, n)}}}}({{\bf{p}}^{{\mathrm{(I)}}}},t)\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}}
...
\begin{equation}
{S^{{\mathrm{(Gnd)}}}}({{\bf{p}}^{{\mathrm{(T)}}}}) = \int\limits_{{\Omega ^{{\mathrm{(Gnd)}}}}} {{\mathop{\rm \mathcal{T}}\nolimits} ({{\bf{p}}^{{\mathrm{(T)}}}},{{\bf{p}}^{{\mathrm{(I)}}}}){S^{{\mathrm{(Gnd)}}}}({{\bf{p}}^{{\mathrm{(I)}}}},t)\left( { - {{\bf{p}}^{{\mathrm{(I)}}}}\cdot {\bf{n}}} \right)d{\Omega ^{{\mathrm{(I)}}}}}
...
\begin{equation}
{S_j}^{{\mathrm{(T,Sky)}}} = {I^{({\bf{Sky}})}}(t)\sum\limits_{i \in {\Omega ^{{\mathrm{(Sky)}}}}} {{T_{ji}}{\Lambda_{ii}}{s_i}}
\end{equation}

where

\begin{equation}
{s_i} = s({{\bf{p}}_i}^{{\mathrm{(I)}}})
\end{equation}
...
\begin{equation}
{S_j}^{{\mathrm{(T, Sf, n)}}} = \sum\limits_{i{\mathrm{ }}down} {{T_{ji}}{\Lambda_{ii}}V_i^{{\mathrm{(Sf, n)}}}{S^{{\mathrm{(Refl, n)}}}}({{\bf{p}}_i}^{{\mathrm{(I)}}},t)}
...
\begin{equation}
{S^{{\mathrm{(Refl, n)}}}}({{\bf{p}}_i}^{{\mathrm{(I)}}},t) = {\rho ^{{\mathrm{(sp, n)}}}}E_{i{\mathrm{ }}r(t)}^{(D,n)} + {\rho ^{{\mathrm{(n)}}}}E_i^n
\end{equation}
...
\begin{equation}
dW_j^{{\mathrm{(f}} \to k{\mathrm{)}}} = {E^{{\mathrm{(}}k{\mathrm{)}}}}({{\bf{p}}_j}^{{\mathrm{(T)}}})d{A^{{\mathrm{(}}k{\mathrm{)}}}} = {S_j}^{{\mathrm{(T)}}} \cdot \left( {{{\bf{n}}^{{\mathrm{(f)}}}} \cdot {{\bf{p}}_j}^{{\mathrm{(T)}}}} \right)\Delta {\Omega_j}^{{\mathrm{(T)}}}d{A^{{\mathrm{(f)}}}}
\end{equation}
...
\begin{equation}
dW_j^{{\mathrm{(f}} \to k{\mathrm{)}}} = {E^{{\mathrm{(}}k{\mathrm{)}}}}({{\bf{p}}_j}^{{\mathrm{(T)}}})d{A^{{\mathrm{(}}k{\mathrm{)}}}} = {S_j}^{{\mathrm{(T)}}}\Lambda_{jj}^{{\mathrm{(T)}}}d{A^{{\mathrm{(f)}}}}
\end{equation}
...
\begin{equation}
{{\bf{x}}^{{\mathrm{(}}k{\mathrm{)}}}} = {{\mathop{\rm \mathcal{P}}\nolimits} ^{{\mathrm{(}}k{\mathrm{)}}}}({\bf{p}}_j^{{\mathrm{(T)}}},{{\bf{x}}^{{\mathrm{(f)}}}}) \equiv {{\mathop{\rm \mathcal{P}}\nolimits}_j}^{{\mathrm{(}}k{\mathrm{)}}}({{\bf{x}}^{{\mathrm{(f)}}}})
\end{equation}

where \textbf{\emph{x}}\(^{(k)}\) is in the plane of surface \emph{k}, and a geometric form factor by:

\begin{equation}
F_j^{{\mathrm{(}}k{\mathrm{)}}} = \frac{1}{{{A^{{\mathrm{(f)}}}}}}\int\limits_{{{\mathop{\rm \mathcal{P}}\nolimits}_j}^{{\mathrm{(}}k{\mathrm{)}}}({{\bf{x}}^{{\mathrm{(f)}}}}) \in {A^{{\mathrm{(}}k{\mathrm{)}}}}} {d{A^{{\mathrm{(f)}}}}}
\end{equation}
...
\begin{equation}
{W^{{\mathrm{(Sky), }}k}} = {I^{({\bf{Sky}})}}(t)\sum\limits_j {\Lambda_{jj}^{{\mathrm{(T)}}}F_j^{{\mathrm{(}}k{\mathrm{)}}}\sum\limits_{i{\mathrm{ }}down} {{T_{ji}}{\Lambda_{ii}}V_i^{{\mathrm{(Sky)}}}A_{ji}^{{\mathrm{(f, Sky), }}k}{s_i}} }
\end{equation}
...
\begin{equation}
{W^{{\mathrm{(Sky), }}k}} = {I^{({\bf{Sky}})}}(t){Z^{{\mathrm{(Sky), }}k}}
\label{eq:WSkykEquation}
\end{equation}

\begin{equation}
\begin{array}{c}{W^{{\mathrm{(Sf,n)}},k}} = {I^{{\mathrm{(D)}}}}(t){\rho ^{{\mathrm{(sp, n)}}}}{Z_{{\mathrm{r(}}t{\mathrm{)}}}}^{{\mathrm{(sp, Sf, n)}},k} + {I^{{\mathrm{(D)}}}}(t){\rho ^{{\mathrm{(n)}}}}{Z_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(Sun, Sf, n)}},k}\\ + {I^{({\bf{Sky}})}}(t){\rho ^{{\mathrm{(n)}}}}{Z^{{\mathrm{(Sky, Sf, n)}},k}}\end{array}
\end{equation}

\begin{equation}
{W^{{\mathrm{(Gnd)}},k}} = {I^{{\mathrm{(D)}}}}(t){\rho ^{{\mathrm{(Gnd)}}}}{Z_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(D, Gnd)}},k} + {I^{({\bf{Sky}})}}(t){\rho ^{{\mathrm{(Gnd)}}}}{Z^{{\mathrm{(Sky, Gnd)}},k}}
\end{equation}
...
\begin{equation}
{K^{{\mathrm{(Sky), }}l}} = {A^{{\mathrm{(f)}}}}\sum\limits_{i{\mathrm{ }}down} {{\mathop{\rm \mathcal{A}}\nolimits}_i^{F,l}{\Lambda_{ii}}V_i^{{\mathrm{(Sky)}}}{s_i}}
\end{equation}

\begin{equation}
{Q^{{\mathrm{(Sky), }}l}} = {I^{({\bf{Sky}})}}(t){K^{{\mathrm{(Sky), }}l}}
\end{equation}

\begin{equation}
{K_{{\mathrm{r(}}t{\mathrm{)}}}}^{{\mathrm{(sp, Sf, n)}},l} = {A^{{\mathrm{(f)}}}}{\mathop{\rm \mathcal{A}}\nolimits}_{r(t)}^{F,l}{\Lambda_{{\mathrm{ r(}}t{\mathrm{) r(}}t{\mathrm{)}}}}V_{{\mathrm{ r(}}t{\mathrm{)}}}^{{\mathrm{(Sf, n)}}}U_{{\mathrm{ r(}}t{\mathrm{) s(}}t{\mathrm{)}}}^{{\mathrm{(D,n)}}}
\end{equation}

\begin{equation}
{K_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(Sun, Sf, n)}},l} = {A^{{\mathrm{(f)}}}}\sum\limits_{i{\mathrm{ }}down} {{\mathop{\rm \mathcal{A}}\nolimits}_i^{F,l}{\Lambda_{ii}}V_i^{{\mathrm{(Sf, n)}}}U_{i{\mathrm{ }}Sun(tsh)}^{{\mathrm{(D,n)}}}}
\end{equation}

\begin{equation}
{K^{{\mathrm{(Sky, Sf, n)}},l}} = {A^{{\mathrm{(f)}}}}\sum\limits_{i{\mathrm{ }}down} {{\mathop{\rm \mathcal{A}}\nolimits}_i^{F,l}{\Lambda_{ii}}V_i^{{\mathrm{(Sf, n)}}}U_i^{{\mathrm{(Sky, n)}}}}
\end{equation}

\begin{equation}
\begin{array}{c}{Q^{{\mathrm{(Sf,n)}},l}} = {I^{{\mathrm{(D)}}}}(t){\rho ^{{\mathrm{(sp, n)}}}}{K_{{\mathrm{r(}}t{\mathrm{)}}}}^{{\mathrm{(sp, Sf, n)}},l} + {I^{{\mathrm{(D)}}}}(t){\rho ^{{\mathrm{(n)}}}}{K_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(Sun, Sf, n)}},l}\\ + {I^{({\bf{Sky}})}}(t){\rho ^{{\mathrm{(n)}}}}{K^{{\mathrm{(Sky, Sf, n)}},l}}\end{array}
\end{equation}

\begin{equation}
{K_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(D, Gnd)}},l} = {A^{{\mathrm{(f)}}}}\sum\limits_{i{\mathrm{ }}up} {{\mathop{\rm \mathcal{A}}\nolimits}_i^{F,l}{\Lambda_{ii}}V_i^{{\mathrm{(Gnd)}}}U_{i{\mathrm{ }}Sun(tsh)}^{{\mathrm{(D, Gnd)}}}}
\end{equation}

\begin{equation}
{K^{{\mathrm{(Sky, Gnd)}},l}} = {A^{{\mathrm{(f)}}}}\sum\limits_{i{\mathrm{ }}up} {{\mathop{\rm \mathcal{A}}\nolimits}_i^{F,l}{\Lambda_{ii}}V_i^{{\mathrm{(Gnd)}}}U_i^{{\mathrm{(Sky, Gnd)}}}}
\end{equation}

\begin{equation}
{Q^{{\mathrm{(Gnd)}},l}} = {I^{{\mathrm{(D)}}}}(t){\rho ^{{\mathrm{(Gnd)}}}}{K_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(D, Gnd)}},l} + {I^{({\bf{Sky}})}}(t){\rho ^{{\mathrm{(Gnd)}}}}{K^{{\mathrm{(Sky, Gnd)}},l}}
\end{equation}

\begin{equation}
{K_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(Sun)}},l} = {A^{{\mathrm{(f)}}}}{\mathop{\rm \mathcal{A}}\nolimits}_{{\mathrm{s}}(t)}^{F,l}\cos {\theta_{{\mathrm{s(}}t{\mathrm{)}}}}^{{\mathrm{(Sun)}}}V_{i{\mathrm{ s(}}t{\mathrm{)}}}^{{\mathrm{(D)}}}
\end{equation}
...
\begin{equation}
S({{\bf{p}}^{{\mathrm{(T)}}}}) = \tau ({{\bf{p}}^{{\mathrm{(T)}}}}) \cdot E({{\bf{p}}^{{\mathrm{(T)}}}})
\end{equation}
