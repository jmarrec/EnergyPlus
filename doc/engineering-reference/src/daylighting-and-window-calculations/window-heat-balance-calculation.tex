...
\begin{equation}
{S_{2j - 1}} = {S_{2j}} = \frac{1}{2}\left( {I_{bm}^{ext}\cos \phi A_j^f(\phi ) + I_{dif}^{ext}A_j^{f,dif} + I_{sw}^{{\mathop{\rm int}} }A_j^{b,dif}} \right),{\mathrm{    ~}}j = 1{\mathrm{~to~}}N
\end{equation}
...
\begin{equation}
{{\mathrm{\tau }}_{bb}}\left( {\mathrm{\theta }} \right) = \left\{ \begin{array}{l}{{\mathrm{\tau }}_{bb}}{\mathrm{(\theta }} = {\mathrm{0)}} \cdot {\mathrm{co}}{{\mathrm{s}}^{\mathrm{b}}}{\kern 1pt} \left( {\frac{{\mathrm{\theta }}}{{{{\mathrm{\theta }}_{{\mathrm{cutoff}}}}}} \cdot \frac{\pi }{2}} \right)\quad \theta  < {\theta_{CutOff}}\\0\quad \quad \quad \theta  \ge {\theta_{CutOff}}\end{array} \right.
\end{equation}
...
\begin{equation}
{\mathrm{\tau }}_{{\mathrm{bt}}}^{}\left( {\mathrm{\theta }} \right) = {\mathrm{\tau }}_{{\mathrm{bt}}}^{}{\mathrm{(\theta }} = {\mathrm{0)}} \cdot {\mathrm{co}}{{\mathrm{s}}^{\mathrm{b}}}{\kern 1pt} \left( {\mathrm{\theta }} \right)
\end{equation}
