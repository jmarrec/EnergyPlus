...
\begin{equation}
Heat~Pump~Water~Heater~Compressor~Part{\mathrm{ - }}Load~Ratio = PLR
\end{equation}

\begin{equation}
Heat~Pump~Water~Heater~On{\mathrm{ - }}Cycle~Parasitic~Electric~Power~(W) = {P_{parasitic,on}}\left( {PLR} \right)
\end{equation}

\begin{equation}
\begin{split}
Heat~Pump~Water~Heater~On{\mathrm{ - }}Cycle~Parasitic~Electric~Consumption~(J) = \\{P_{parasitic,on}}\left( {PLR} \right)\left( {3600} \right){t_{sys}}
\end{split}
\end{equation}

\begin{equation}
\begin{split}
Heat~Pump~Water~Heater~Off{\mathrm{ - }}Cycle~Parasitic~Electric~Power~(W) = \\{P_{parasitic,off}}\left( {1 - PLR} \right)
\end{split}
\end{equation}

\begin{equation}
\begin{split}
Heat~Pump~Water~Heater~Off{\mathrm{ - }}Cycle~Parasitic~Electric~Consumption~(J) = \\{P_{parasitic,off}}\left( {1 - PLR} \right)\left( {3600} \right)\left( {{t_{sys}}} \right)
\end{split}
\end{equation}
